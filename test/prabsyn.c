 ...
 * @Description: Print Abstract syntax module.
 * @Date: 2019-10-21 19:12:22
 * @Last Modified: 2020-01-08 22:35:46
 */
#include <stdio.h>
#include "util.h"
#include "absyn.h"
...
void pr_exp(FILE *out, A_exp v, int d) {
  ...
  case A_ifExp:
    fprintf(out, "iffExp(\n");
    pr_exp(out, v->u.iff.cond, d+1); fprintf(out, ",\n");
  ...
  case A_whileExp:
    ...
    pr_exp(out, v->u.whilee.cond, d+1); fprintf(out, ",\n");
